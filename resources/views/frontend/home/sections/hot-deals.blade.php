                            ...
                            <div class="wsus__product_item">
                                ...
                                <ul class="wsus__single_pro_icon">
                                    <li><a href="#" data-bs-toggle="modal"
                                            data-bs-target="#product_hot_deals-{{ $product->id }}"><i
                                ...
                                <div class="wsus__product_details">
                                    ...
                                    @else
                                        <p class="wsus__price">
                                            {{ $settings->currency_icon }}{{ $product->price }}<del></del>
                                        </p>
                                    @endif
                                    <form class="shopping-cart-form">
                                        ...
                                        @endforeach
                                        <input type="hidden" name="qty" type="text" min="1"
                                            max="100" value="1" />
...
@foreach ($typeBaseProducts as $key => $products)
    @foreach ($products as $product)
        <section class="product_popup_modal">
            <div class="modal fade" id="product_hot_deals-{{ $product->id }}" tabindex="-1" aria-hidden="true">
